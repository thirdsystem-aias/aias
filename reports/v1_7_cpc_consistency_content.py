"""
v1.7 — CPC Consistency Methodology Lock · brand-format report content (managerial register).

Third System™ brand-format report for the AIAS™ Measurement Program. Pure-data
content module consumed by reports/build_report_v1_7.py (ReportLab + pypdf two-pass).
...
DEPLOY TARGET: reports/v1_7_cpc_consistency_content.py
...
build_report_v1_7.py imports, and align the shapes if the builder expects different
...
COVER = {
    ...
    "program_line": "AIAS™ Measurement Program · Methodology v1.7 · Third System™",
}
