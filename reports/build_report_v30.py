...
# Make `import v30_cpc_instrument_pilot_content` work regardless of working directory.
sys.path.insert(0, str(SCRIPT_DIR))
import v30_cpc_instrument_pilot_content as content  # noqa: E402
...
if isinstance(content.CLOSING, str):
    content.CLOSING = {
        ...
        "datasets": [
            "Human norms: osf.io/ec6wh/v30/prereg/v0_30_brand_validator.csv",
            "AIAS Presence: osf.io/ec6wh/v30/data/v0.30_presence.csv",
            "Scoring verdicts: osf.io/ec6wh/v30/v30_verdicts.json",
        ],
...
def build_closing_story(styles: dict, brand: dict) -> list:
    ...
    # v0.30 protocol version — v1.6 (Phantom Brand Persistence increment Inc3)
...
def build(*, debug_layout: bool = False,
    ...
    V22_DEPOSIT_ROOT = AIAS_ROOT / "osf" / "v30"
    # Charts live in reports/figs/ (figs root) — build_charts_v30.py default
    # fig-dir, and the same chart_28_*.pdf the academic paper references.
    chart_dir = chart_dir or (AIAS_ROOT / "reports" / "figs")
    output_path = output_path or (V22_DEPOSIT_ROOT / "reports" / "v30_cpc_instrument_pilot_report.pdf")
    base_pdf = output_path.parent / "_v30_base.pdf"
    ...
    doc = V15DocTemplate(
        ...
        title="What AI Presence Does Not Predict \u2014 AIAS v0.30",
