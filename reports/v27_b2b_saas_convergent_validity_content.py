...
EXEC_SUMMARY = (
    ...
    "scores, and recall-SOM converges with them. Nor is it range restriction — "
    "Share-of-Voice actually varies more than the dimensions that beat it. The "
    "problem is that its variation does not co-rank with AIAS recall: it is "
    "tie-heavy (7 of 19 live brands sit at one value), and it measures competitive "
    "share, while the dimensions that do converge — presence quality, brand "
    "recognition — measure brand knowledge and prominence, the same thing recall "
    "captures. They vary less, yet they track recall, consistent with AIAS's "
    "earlier convergence with Google Trends search interest (v0.25, rho = 0.74).\n\n"
...
PATTERNS = [
    ...
    },
    {
        ...
        "body": (
            ...
            "What does explain it is rank-alignment, not spread. Share of "
            "Voice actually varies more than the dimensions that beat it — its "
            "spread exceeds presence quality’s and brand recognition’s — but "
            "its variation does not co-rank with recall. Two things drive the "
            "gap: Share of Voice is tie-heavy (7 of 19 live brands sit at "
            "exactly 7.33/10, so it can barely order salient brands), and it "
            "measures competitive share rather than the brand-knowledge "
            "prominence recall captures. Presence quality and brand recognition "
            "vary less, yet their order tracks recall. One detail sharpens "
            "this: the Grader’s own brand-recognition subscore tracks recall-SOM "
            "even though AIAS’s recognition measure is at the ceiling — the "
            "graded version behaves like a prominence measure, which is what "
            "recall-SOM is.\n\n"
            ...
            "result; the rank-misaligned competitive-share score it fails on is the "
...
CLOSING = (
    ...
    "and brand-recognition signals, and fails only on the headline metric, "
    "whose variation does not co-rank with recall.\n\n"
