"""
v0.31 — CPC Cross-Category Baseline
Third System™ brand-format report content module.

Pure-data module. Managerial register (P1–P5 propositional framing; NOT the
paper's H_* framing). Consumed by reports/build_report_v31.py (forked from v30);
the builder maps the four v31 chart PDFs into the proposition slots:
...
# ----------------------------------------------------------------------------
COVER = {
    "eyebrow": "Third System™ · AIAS™ Measurement Program · v0.31",
