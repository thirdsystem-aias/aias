# NOTE: cloned from v23_luxury_watches_content.py on phase scaffold.
# All COVER, STANDFIRST, LEAD_DECK, EXEC_SUMMARY, PATTERNS,
# LIMITATIONS, WHATS_NEXT, HYPOTHESIS_DETAILS, CLOSING text
# must be re-written for the v0.24 b2b saas
# substrate. Do not ship this file as-is.

# NOTE: cloned from v22_automotive_content.py on phase scaffold.
# All COVER, STANDFIRST, LEAD_DECK, EXEC_SUMMARY, PATTERNS,
# LIMITATIONS, WHATS_NEXT, HYPOTHESIS_DETAILS, CLOSING text
# must be re-written for the v0.24 luxury watches
# substrate. Do not ship this file as-is.

"""
v24_automotive_content.py — Content module for the v0.24 Third System
brand-format report.

Forked from v21_cosmetics_content.py with surgical content changes only.
Schema matches the contract consumed by build_report_v24.py (which is the
...
resolved in build_report_v24.py via _slot_lookup() to the v0.24 chart
filenames in reports/figs/v24/. v0.24 carries four findings (vs v0.21's
...
STANDFIRST = (
    "AIAS\u2122 v0.24 stress-tests Phantom Brand Persistence on a "
...
LEAD_DECK = (
    "Four findings shape the v0.24 phase. First, Recognition saturates "
...
EXEC_SUMMARY = [
    (
        ...
        "measurement (Inc3). v0.24 is the first prospective phase under v1.6 "
    ...
    (
        ...
        "panel novel to v0.24: Pontiac (closed 2010), Oldsmobile (2004), "
    ...
    (
        "Six hypotheses were pre-registered (tags v0.24-prereg-r1 superseded "
        "by v0.24-prereg-r2 \u2014 the r1 \u2192 r2 amendment corrected an "
...
WHAT_WE_MEASURED = {
    ...
    "paragraphs": [
        (
            ...
            "any data collection (tag v0.24-prereg-r2, superseding r1 \u2014 "
            ...
            "DEVIATIONS Entry 0 in prereg/v0_24_automotive_content.py)."
        ),
        (
        ...
        (
            ...
            "lead measurement of v0.24. R_phantom_defunct for each Cell D "
        ...
        (
            ...
            "In v0.24 these patterns are descriptive overlays on top of the "
            "six locked hypotheses; H_Type2_emergence is not in the v0.24 "
...
PATTERNS = [
    ...
    },
    {
        ...
        "paragraphs": [
            (
                ...
                "v0.24 contributes seventeen Iwachu cases on the automotive "
            ...
            (
                ...
                "the substantive Iwachu base for v0.24 is twelve cases "
    ...
    },
    {
        ...
        "paragraphs": [
            (
                "v0.24 produces seven Type 2 cases (R_cat \u2264 2 \u2227 "
            ...
            (
                ...
                "4 C2 path cannot evaluate it \u2014 and v0.24 supplies "
    ...
    },
    {
        ...
        "paragraphs": [
            (
                ...
                "surface a single time. H_Phantom_Defunct, the v0.24 lead "
            ...
            (
                ...
                "alive, anchors the upper bound); v0.24 Cell D R_phantom "
...
LIMITATIONS = {
    ...
    "paragraphs": [
        (
            ...
            "for audit; r2 is the operative lock for v0.24."
        ),
        (
        ...
        (
            ...
            "of these affect the v0.24 verdicts under the locked "
        ...
        (
            ...
            "future-phase horizons. v0.24\u2019s phantom-defunct "
...
WHATS_NEXT = {
    ...
    "paragraphs": [
        (
            "<b>Six-family anchor base reached.</b> With v0.24 in place, "
        ...
        (
            ...
            "upper-end demonstration. v0.24 Cell D (R_phantom_defunct = 0, "
            ...
            "demonstrably surfaced in v0.24 Phase B). Phase 2 would lift "
        ...
        (
            ...
            "outstanding.</b> The CONFIRMED verdict in v0.24 is robust to "
        ...
        (
            ...
            "v0.21 five-family base. v0.24 extends the Presence base to "
...
HYPOTHESIS_SCORING = {
    ...
    "intro": (
        "Six hypotheses were pre-registered at tag v0.24-prereg-r2 "
...
HYPOTHESIS_DETAILS = {
    ...
    "intro": (
        ...
        "v0.24+ trajectory is what the prose below addresses."
    ),
    "items": [
        (
            "H_Phantom_Defunct",
        ...
        (
            ...
            "by Phase B Recall, which v0.24 produces in rich form (seven "
        ...
        (
            ...
            "for v0.24 is twelve cases across Cells A, B, and C \u2014 "
        ...
        (
            ...
            "v0.24 supplies the cleanest demonstration the program has "
            ...
            "exact bootstrap procedure before v0.24+ phases run against "
            "it."
        ),
        (
            "H_SubstrateRecognition_PreScreen",
            ...
            "panel) pairing at acquisition time. A v0.24 replication on a "
...
CLOSING = {
    ...
    "datasets": [
        "v0.24 Phase A acquisition (Recognition C_P, n = 144 probes): "
        "osf.io/ec6wh/v24/data/phase_a_results.csv",
        "v0.24 Phase B acquisition (Recall two-channel, n = 36 queries): "
        "osf.io/ec6wh/v24/data/phase_b_results.csv",
        "v0.24 scoring verdicts (six hypothesis matrices resolved): "
        "osf.io/ec6wh/v24/data/v24_verdicts.json",
        "v0.24 pre-registration (Python module, code-importable, r2 "
        "supersedes r1): osf.io/ec6wh/v24/prereg/v0_24_automotive_content.py",
        "v0.24 mega-prompt (DEVIATIONS Entry 0 documents the r1 \u2192 r2 "
        "amendment): osf.io/ec6wh/v24/prereg/v0_24_mega_prompt.md",
    ],
    "methodology_log": (
        "v0.24 pre-registration locked at git tag v0.24-prereg-r2 (commit "
        ...
        "tag v0.24-acquisition-locked. Academic companion: SSRN TBD"
    ),
}
