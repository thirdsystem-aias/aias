...
import v35_phantom_cpc_omnibus_content as content  # noqa: E402
...
# HYPOTHESIS_SCORING (v0.35): [{id, proposition, verdict, basis}] → {heading, intro, rows}
...
# HYPOTHESIS_DETAILS (v0.35 dict P1-P5) is consumed into the P-findings above;
...
if isinstance(content.CLOSING, str):
    content.CLOSING = {
        ...
        "datasets": [
            "Verdicts: osf.io/ec6wh/v35/v35_verdicts.json",
            "Two-wave acquisition data: osf.io/ec6wh/v35/data/",
            "Scoring code: osf.io/ec6wh/v35/scripts/score_v35.py",
            "Pre-registration: osf.io/ec6wh/v35/prereg/ (tag v0.35-prereg-r1)",
        ],
        "methodology_log": "v0.35 (SSRN pending)",
...
if isinstance(content.CLOSING, dict):
    ...
    content.CLOSING.setdefault("methodology_log", "v0.35 (SSRN pending)")
...
class V15DocTemplate(BaseDocTemplate):
    ...
    def _body_chrome(self, canvas: Canvas, doc):
        ...
        c.drawRightString(PAGE_W - MARGIN, header_y - 8,
                           "AIAS\u2122 Consistency (CPC) \u00b7 v0.35 \u00b7 June 2026")
