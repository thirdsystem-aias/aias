...
# Make `import v32_cpc_version_stability_content` work regardless of working directory.
sys.path.insert(0, str(SCRIPT_DIR))
import v32_cpc_version_stability_content as content  # noqa: E402
...
# v0.32: PATTERNS is a synthesis prose string; the chart-bearing findings ARE the
...
# HYPOTHESIS_SCORING (v0.32): [{id, proposition, verdict, basis}] → {heading, intro, rows}
...
# HYPOTHESIS_DETAILS (v0.32 dict P1-P5) is consumed into the P-findings above;
...
if isinstance(content.CLOSING, str):
    content.CLOSING = {
        ...
        "datasets": [
            "Per-brand CPC: osf.io/ec6wh/v32/data/v32_cpc.csv",
            "Verdicts: osf.io/ec6wh/v32/v32_cpc_verdicts.json",
            "Scoring code: osf.io/ec6wh/v32/scripts/score_v0_32.py",
        ],
        "methodology_log": "v0.32 (SSRN pending)",
...
if isinstance(content.CLOSING, dict):
    ...
    content.CLOSING.setdefault("methodology_log", "v0.32 (SSRN pending)")
...
class V15DocTemplate(BaseDocTemplate):
    ...
    def _body_chrome(self, canvas: Canvas, doc):
        ...
        c.drawRightString(PAGE_W - MARGIN, header_y - 8,
                           "AIAS\u2122 Consistency (CPC) \u00b7 v0.32 \u00b7 June 2026")
...
def build_closing_story(styles: dict, brand: dict) -> list:
    ...
    citation_text = (
        ...
        "AIAS Consistency Component (CPC), v0.32</i>. "
        "Third System (SSRN pending). thirdsystem.ai/v32"
    )
...
def build(*, debug_layout: bool = False,
    ...
    V22_DEPOSIT_ROOT = AIAS_ROOT / "osf" / "v32"
    # v0.32 figures live in reports/figs/v32/ (build_charts_v32.py default
    # fig-dir), the same chart_0*.pdf the SSRN paper references.
    chart_dir = chart_dir or (AIAS_ROOT / "reports" / "figs" / "v32" / "report")
    output_path = output_path or (V22_DEPOSIT_ROOT / "reports" / "v32_cpc_version_stability_report.pdf")
    base_pdf = output_path.parent / "_v32_base.pdf"
    ...
    doc = V15DocTemplate(
        ...
        title="Consistency, Category by Category \u2014 AIAS v0.32",
