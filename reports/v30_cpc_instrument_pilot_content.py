# NOTE: cloned from v28_tech_brand_discriminant_content.py on phase scaffold.
# All COVER, STANDFIRST, LEAD_DECK, EXEC_SUMMARY, PATTERNS,
# LIMITATIONS, WHATS_NEXT, HYPOTHESIS_DETAILS, CLOSING text
# must be re-written for the v0.30 CPC instrument pilot
# substrate. Do not ship this file as-is.

"""
v30_cpc_instrument_pilot_content.py

AIAS™ v0.30 / CV.04 --- managerial brand-format report content.
Discriminant validity of AIAS Presence against human brand norms (Technology, n = 24).

Authored from the LOCKED verdicts (osf/v30/v30_verdicts.json, tag v0.30-results-locked);
results-aware. Replaces the v0.26 Amazon-BSR carryover wholesale.

Consumed by reports/build_report_v30.py. Attribute contract:
...
CLOSING = {
    ...
    "datasets": (
        ...
        "deposited at OSF (osf.io/ec6wh, v30)."
    ),
    "methodology_log": (
        "Pre-registered at git tags v0.30-prereg-r1 / r2 before any model was queried. "
        ...
        "Verdicts locked at v0.30-results-locked and deposited unchanged."
    ),
}
