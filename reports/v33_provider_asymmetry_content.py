"""
v0.33 - Provider-Asymmetric CPC - Brand-format report content module.
...
(osf/v33/v33_provider_asymmetry_verdicts.json; commit fdceda9). Honest framing:
...
lists of dicts - align types to build_report_v33.py when the builder is rewritten.)
"""
