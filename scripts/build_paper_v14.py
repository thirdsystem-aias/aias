...
Inputs:
    ~/aias/papers/v14_ssrn_paper_draft.md   — source markdown (Carlito YAML)
    ~/aias/osf/v14/figures/*.pdf             — embedded figures

Outputs:
    ~/aias/papers/v14/v14_ssrn_paper.pdf     — final PDF
    ~/aias/papers/v14/preamble_v14.tex       — generated LaTeX preamble
    ~/aias/papers/v14/v14_ssrn_paper_build.md — patched source (figure paths)
...
v0.12 source. Build rewrites to figures/... and adds ~/aias/osf/v14/ to
pandoc's --resource-path search list.

Run:
    python ~/aias/scripts/build_paper_v14.py

To force a rebuild of the figures themselves first:
    python ~/aias/scripts/build_charts_v14.py && python ~/aias/scripts/build_paper_v14.py
"""
...
V14_DIR = PAPERS_DIR / "v14"
V14_DIR.mkdir(parents=True, exist_ok=True)

SOURCE = PAPERS_DIR / "v14_ssrn_paper_draft.md"
RESOURCE_BASE = HOME / "aias" / "osf" / "v14"  # figures live at RESOURCE_BASE/figures/

OUT_PDF = V14_DIR / "v14_ssrn_paper.pdf"
PREAMBLE = V14_DIR / "preamble_v14.tex"
BUILD_MD = V14_DIR / "v14_ssrn_paper_build.md"  # patched source
...
cmd = [
    ...
    f"--resource-path={V14_DIR}:{RESOURCE_BASE}",
    str(BUILD_MD),
    "-o", str(OUT_PDF),
]
