#!/usr/bin/env python3
"""
v1.8 CPC — figure builder (one per finding).
...
Reads osf/methodology/v1_8/data/v1_8_cpc.csv. House style via chart_style.py.
Outputs PDFs to reports/figs/v1_8/.
"""
import sys, csv, json
...
SOURCE_PHASE = "v1.8 (CPC.r3)"

rows = list(csv.DictReader(open(ROOT / "osf/methodology/v1_8/data/v1_8_cpc.csv")))
for r in rows:
...
def fig_01_cpc_defined():
    ...
    cs.add_footer(fig, verdict="H_CPC_Defined FALSIFIED — pooled defined-rate 57% (43% of in-market brands N/A).",
                  phase=SOURCE_PHASE, protocol="v1.8-prereg-r2")
