#!/usr/bin/env python3
"""
AIAS v0.24 — Premium Spirits Chart Builder
Reads osf/v24/v24_verdicts.json, outputs 4 chart PDFs to reports/figs/v24/
...
Usage:
  ...
  python3 scripts/build_charts_v24.py
"""
...
VERDICTS_PATH = PIPELINE_ROOT / "osf" / "v24" / "v24_verdicts.json"
FIGS_DIR = PIPELINE_ROOT / "reports" / "figs" / "v24"
...
SOURCE_LINE = "AIAS\u2122 v0.24 | Protocol v1.6 | Third System\u2122"
...
def chart_composite_bar(verdicts):
    ...
    add_header(fig,
               ...
               "Protocol v1.6 \u2014 Premium Spirits (v0.24)",
...
def main():
    ...
    print("=" * 60)
    print("AIAS v0.24 \u2014 Chart Builder (Premium Spirits)")
    print("=" * 60)
