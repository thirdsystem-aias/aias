...
Usage:
  ...
  python3 scripts/build_paper_v0_37.py
"""
...
PAPER_DIR = PIPELINE_ROOT / "papers" / "v0_37"
SOURCE_MD = PAPER_DIR / "v0_37_ssrn_paper_draft.md"
OUTPUT_PDF = PAPER_DIR / "v0_37_ssrn_paper.pdf"
...
UNICODE_SUBS = [
    ...
    ("\u2227", r"$\wedge$"),    # ∧
    ("\u2713", r"\checkmark"),   # ✓
    # CV.04 glyph gaps surfaced by xelatex/Carlito on the v0.37 source:
