#!/usr/bin/env python3
"""
v0.37 Naive-Phantom x CPC Omnibus — figure builder (register-neutral).
...
the host documents' captions carry register. SSOT: osf/v37/v37_verdicts.json —
every numeric value is pulled programmatically. The ONLY hardcoded numeric
constants are the locked verdict thresholds +/-0.15 / +/-0.30 (v0.37-prereg-r1)
...
SOURCE_PHASE = "v0.37 (Naive-Phantom × CPC)"
PROTOCOL = "v0.37-prereg-r1"
...
LO, HI = 0.15, 0.30   # locked verdict thresholds, v0.37-prereg-r1
...
ROSTER = list(csv.DictReader(open(ROOT / "osf/v37/data/v37_phantom_roster.csv")))
...
if __name__ == "__main__":
    print("building v0.37 figures -> reports/figs/v37/  (register-neutral)")
    ...
    for pdf in sorted(FIG_DIR.glob("chart_0*.pdf")):
        ...
        print(f"  deposited {pdf.name} -> osf/v37/figures/")
    print("done")
