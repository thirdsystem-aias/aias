...
Usage:
  ...
  python3 scripts/build_paper_v0_27.py
"""
...
PAPER_DIR = PIPELINE_ROOT / "papers" / "v0_27"
SOURCE_MD = PAPER_DIR / "v0_27_convergent_validity_DRAFT.md"
OUTPUT_PDF = PAPER_DIR / "v0_27_convergent_validity.pdf"
...
UNICODE_SUBS = [
    ...
    ("₃", r"$_{3}$"),
    ("ₜ", r"$_{t}$"),
    ("−", "-"),            # minus sign U+2212 (Carlito gap) -> ASCII hyphen-minus
]
