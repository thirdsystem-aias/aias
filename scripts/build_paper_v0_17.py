...
% --- Graphics support for embedded figures -----------------------------
% graphicspath tells \includegraphics where to look. The v0.17 paper
% places figures at papers/v0_17/figures/; the v1.4 paper has no figures
% but the package load is harmless.
\usepackage{graphicx}
\graphicspath{{papers/v0_17/figures/}{papers/v1_4_methodology/figures/}{figures/}}
