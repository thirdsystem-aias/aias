...
Usage:
  ...
  python3 scripts/build_paper_v0_32.py
"""
...
PAPER_DIR = PIPELINE_ROOT / "papers" / "v0_32"
SOURCE_MD = PAPER_DIR / "v0_32_ssrn_paper_draft.md"
OUTPUT_PDF = PAPER_DIR / "v0_32_ssrn_paper.pdf"
...
UNICODE_SUBS = [
    ...
    ("\u2227", r"$\wedge$"),    # ∧
    ("\u2713", r"\checkmark"),   # ✓
    # CV.04 glyph gaps surfaced by xelatex/Carlito on the v0.32 source:
