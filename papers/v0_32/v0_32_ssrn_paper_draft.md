...
\textit{Working paper. Pre-registered at} \texttt{v0.32-prereg-r1}.\\[0.2em]
...
**Paper status:** Working paper. Pre-registered at `v0.32-prereg-r1`; retroactive rescore, no new data collection.
...
![Reconciliation of the channel-agnostic unit against the locked v1.7 instrument across the three two-channel substrates. All seventy-two brands fall on the identity line.](../../reports/figs/v32/chart_01_reconciliation_gate.pdf){#fig:gate width=100%}
...
![Brand-level CPC within each confirmatory substrate, defined brands only, with substrate medians and per-substrate N.](../../reports/figs/v32/chart_02_cpc_within_substrate.pdf){#fig:within width=100%}
...
![Cross-category CPC distributions across the five confirmatory substrates, with the Kruskal–Wallis statistic annotated.](../../reports/figs/v32/chart_03_cpc_cross_category.pdf){#fig:cross width=100%}
...
![Defined and undefined brand counts per substrate under the mean-recall floor.](../../reports/figs/v32/chart_04_defined_undefined_floor.pdf){#fig:floor width=100%}
...
**Data and code availability.** Pre-registration, recall data, scoring code, and figures are deposited at the Open Science Framework (osf.io/ec6wh, v32 component). The methodology was locked at git tag `v0.32-prereg-r1` prior to scoring.
