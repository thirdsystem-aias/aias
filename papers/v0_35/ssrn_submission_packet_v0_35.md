...
- **File:** `papers/v0_35/v0_35_ssrn_paper.pdf`
...
2. **Update memory:** add the v0.35 SSRN abstract ID entry to the recent_updates section of userMemories.
3. **Run final OSF deposit:** `python3 ~/aias/scripts/osf_upload.py ~/aias/osf/v35 v35`
4. **Cross-citation** in next phase: this v0.35 SSRN ID gets added to next phase's paper bibliography upstream-phases line.

---

**End of submission packet — v0.35 ready to upload.**
