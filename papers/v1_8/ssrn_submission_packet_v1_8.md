# SSRN Submission Packet — AIAS™ v1.8

**Paper:** Consistency without Independence
**File to upload:** `papers/v1_8/v1_8_ssrn_paper.pdf`
...
```
Pre-registration artifacts, scoring code, the scored dataset, and figures are deposited at OSF (`osf.io/ec6wh/methodology/v1_8`). Consistency values reconcile with the pilot's recorded output to a maximum absolute difference of $2\times10^{-16}$.
```
...
- **File:** `papers/v1_8/v1_8_ssrn_paper.pdf`
...
2. **Update memory:** add the v1.8 SSRN abstract ID entry to the recent_updates section of userMemories.
3. **Run final OSF deposit:** `python3 ~/aias/scripts/osf_upload.py ~/aias/osf/methodology/v1_8 methodology/v1_8`
4. **Cross-citation** in next phase: this v1.8 SSRN ID gets added to next phase's paper bibliography upstream-phases line.

---

**End of submission packet — v1.8 ready to upload.**
