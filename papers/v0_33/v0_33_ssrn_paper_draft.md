...
Pre-registration: \texttt{v0.33-prereg-r1} (no deviations)\\
Data and code: OSF \texttt{ec6wh/v33}\\
...
**Paper status:** Pre-registered re-analysis (tag `v0.33-prereg-r1`); secondary analysis of frozen v0.31 inputs with no new data collection; no deviations from pre-registration. Part of the AIAS measurement program.
...
![Provider within-pair-consistency ranks by substrate (skincare is a genuine tie between Anthropic and OpenAI, shown as 1.5 / 1.5 / 3). Kendall's $W = 0.31$, exact $p = 0.18$: underpowered at five substrates and uninformative about concordance, not disconfirming.](../../reports/figs/v33/chart_03_provider_ranks.pdf){#fig:ranks width=100%}
