...
{\normalsize AIAS Presence Measurement Protocol \textperiodcentered{} Construct-Validity Phase CV.04 (v0.28)\par}
...
\vspace{1.0cm}
{\small Pre-registration: OSF \texttt{osf.io/ec6wh} \textperiodcentered{} tags \texttt{v0.28-prereg-r1 / r2}\\
Data, scoring, and verdicts deposited under \texttt{osf.io/ec6wh} (v28).\par}
...
The study follows the AIAS Presence Measurement Protocol v1.6 (González Castro 2026a). Every hypothesis, threshold, the brand panel, the validator, and the Presence composition rule were committed to git and pushed before any model was queried (tag `v0.28-prereg-r1`); a single amendment fixing a normalization denominator was committed before acquisition (tag `v0.28-prereg-r2`, see §2.5). Acquisition was run blind to the validator, and scoring --- the join of Presence to the human norms --- was executed exactly once, after the data were locked and deposited.
...
**Pre-registration and data availability.** Pre-registration, acquisition data, scoring code, and verdicts are deposited at OSF (`osf.io/ec6wh`, v28), with the design frozen at git tags `v0.28-prereg-r1` and `v0.28-prereg-r2` prior to acquisition and the result at `v0.28-results-locked`.
