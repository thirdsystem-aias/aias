...
# Optional .env loading — non-breaking. If python-dotenv is installed
# AND a .env file exists at the project root, load it before any provider
# call. Uses override=True so .env values WIN over shell-exported vars
# (otherwise stale placeholders in the shell would mask the real .env keys).
try:
