...
**Audit trail.** Phase B script `scripts/phaseB_resolve_v17.py` at commit `55e28ed`. Resolution log `osf/v17/registries/topic_id_resolution_log_v0.17.csv` at commit `55e28ed`. DEVIATIONS Entry 7 (substrate substitution) at commit `9174d10`. This Entry 8 committed at `1b560d2`.
