...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{chart_v17_phase_b_mention_rates.pdf}
\caption{Phase B mention-rate distribution across the 15-brand operational panel, sorted descending and color-coded by tradition cell. Full panel detail and PASS/EXCLUDED tier annotations on the figure itself.}
...
\caption{Per-cell brand survival from registered panel (pre-Phase-A) to operational panel (post-Phase-B). The C1 floor breach summary and full pre/post counts appear on the figure itself.}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{chart_v17_dissociation.pdf}
\caption{Phase A C$_P$ anchoring score versus Phase B mention rate for the four pivot brands. The Iwachu dissociation case is annotated on the figure itself.}
...
González Castro, P. U. (2026d). *The AIAS Presence Measurement Protocol v1.4: Recognition × Recall Decomposition and Multi-Component AI Availability*. SSRN Working Paper 6799479.
