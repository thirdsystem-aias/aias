...
`[VERIFY: ...]` marks one remaining methodological caveat (§4.1, model build-level versioning) that is a transparency disclosure for future runs rather than a blocker for v1.0. All operational and editorial decisions for v1.0 release are settled and baked into the relevant sections.
