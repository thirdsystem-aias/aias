"""
v1.8 — CPC Consistency Methodology Lock · Pre-registration content (r1)
...
Methodology lineage: locked at git tag v1.8-prereg-r1, scope-amended at
v1.8-prereg-r2 (anchored-set narrowing; DEVIATIONS Entry 0), falsification
recorded at v1.8-prereg-r3 (DEVIATIONS Entry 1; the r2 methodology applied
faithfully failed its pre-committed trigger — additive record, methodology
unchanged). No new acquisition in v1.8.
...
METADATA = {
    ...
    "prereg_tag": "v1.8-prereg-r2",   # r1 7d94ac3; r2 narrows anchored set (Entry 0)
...
ILLUSTRATION = {
    ...
    "note": (
        "v1.8 uses existing recall data solely as evidence the protocol is "
...
DEVIATIONS = [
    {
        ...
        "summary": (
            ...
            "re-acquisition path in v1.8; cross-substrate recall back-fill logged "
